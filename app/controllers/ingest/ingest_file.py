...
def ingest_file(upload_file: UploadFile | str, db: Session) -> Dict[str, Any]:
  ...
  # No abrimos transacción aquí, ya la controla el fixture
  for idx, row in df.iterrows():
    ...
    try:
      ...
      db.rollback()  # Asegura que el error no deje la sesión abierta
      continue

  db.commit()  # Cierra transacción si todo fue bien
